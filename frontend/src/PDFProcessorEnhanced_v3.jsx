...
const PDFProcessorEnhanced = () => {
  ...
  const processDocuments = async () => {
    ...
    setProcessing(true);
    setProcessingPlan([]); // Clear previous plan
    setResults([]);
    ...
    <div className="pdf-processor-enhanced">
      ...
      <div className="processor-content">
        ...
        <div className="right-panel">
          ...
          {/* Processing Plan - Show when processing OR when we have a plan */}
              ...
              <div className="plan-steps">
                {processingPlan.length > 0 ? (
                  ...
                  <div className="plan-loading">
                    ...
                    <span className="step-name">Preparing processing plan...</span>
                  </div>
                )}
              </div>
